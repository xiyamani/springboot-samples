...
declare interface ParseInlineStyleOptions extends NormalizeOptions {
}

export declare function parseInlineStyleSync(input: string, options?: ParseInlineStyleOptions): string | undefined;
